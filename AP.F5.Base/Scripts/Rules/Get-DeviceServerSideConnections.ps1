#==================================================================================
# Script: 	Get-DeviceServerSideConnections.ps1
# Date:		11/10/18
# Author: 	Andi Patrick
...
$SCRIPT_NAME			= 'Get-DeviceServerSideConnections.ps1'
$EVENT_LEVEL_ERROR 		= 1
...
# OIDs used
# bigipTrafficMgmt.bigipSystem.sysGlobals.sysGlobalStats.sysGlobalStat.sysStatServerMaxConns5m.0
[string]$sysStatServerMaxConns5m = ".1.3.6.1.4.1.3375.2.1.1.2.1.98.0"
...
Try 
{
	...
	$oidClient = New-Object Lextm.SharpSnmpLib.ObjectIdentifier ($sysStatServerMaxConns5m)
	$vList.Add($oidClient)
	...
	Try {
		...
		if ($Results.Count -gt 0) {
			...
			[string] $message = " Created Property bag for $DeviceAddress`r`n`r`n" 	+ "Server-Side Connections: "  + $Connections + "`r`n"
