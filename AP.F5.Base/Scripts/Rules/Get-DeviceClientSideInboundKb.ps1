#==================================================================================
# Script: 	Get-DeviceClientSideInboundKb.ps1
# Date:		11/10/18
# Author: 	Andi Patrick
...
$SCRIPT_NAME			= 'Get-DeviceClientSideInboundKb.ps1'
$EVENT_LEVEL_ERROR 		= 1
...
[string]$sysStatClientBytesIn5m = ".1.3.6.1.4.1.3375.2.1.1.2.1.88.0"
...
Try 
{
	...
	$oidClient = New-Object Lextm.SharpSnmpLib.ObjectIdentifier ($sysStatClientBytesIn5m)
	$vList.Add($oidClient)
	...
	Try {
		...
		if ($Results.Count -gt 0) {
			...
			[string] $message = " Created Property bag for $DeviceAddress`r`n`r`n" 	+ "Client-Side Inbound (Kb): "  + $NetworkKb + "`r`n"
